...
import seederData from "./activityinfo.seeder.json";
...
const ActivityinfoSeederDialogComponent = (props) => {
...
export default connect(null, mapDispatch)(ActivityinfoSeederDialogComponent);
