...
import seederData from "./personaldetails.seeder.json";
...
const PersonaldetailsSeederDialogComponent = (props) => {
...
export default connect(null, mapDispatch)(PersonaldetailsSeederDialogComponent);
