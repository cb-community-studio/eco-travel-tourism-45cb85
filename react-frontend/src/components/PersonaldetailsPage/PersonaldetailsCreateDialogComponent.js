...
const PersonaldetailsCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        let _data = {
            ...
            passportCountry: _entity.passportCountry
    ...
    return (
        <Dialog header="Create" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div role="personaldetails-create-dialog-component">
                <div>
                ...
                <div>
                    <p className="m-0" >Passport Issuing Country:</p>
                    <InputText className="w-full mb-3" value={_entity?.passportCountry} onChange={(e) => setValByKey("passportCountry", e.target.value)}  />
                </div>
