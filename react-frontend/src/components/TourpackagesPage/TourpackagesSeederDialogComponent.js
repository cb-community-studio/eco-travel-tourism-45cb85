...
import seederData from "./tourpackages.seeder.json";
...
const TourpackagesSeederDialogComponent = (props) => {
...
export default connect(null, mapDispatch)(TourpackagesSeederDialogComponent);
