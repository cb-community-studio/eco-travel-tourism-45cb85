...
import seederData from "./contactdetails.seeder.json";
...
const ContactdetailsSeederDialogComponent = (props) => {
...
export default connect(null, mapDispatch)(ContactdetailsSeederDialogComponent);
